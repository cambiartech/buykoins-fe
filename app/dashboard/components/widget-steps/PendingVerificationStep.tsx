...
export function PendingVerificationStep({
  theme,
}: PendingVerificationStepProps) {
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className={`text-sm font-sequel ${
              ...
              Your setup has been submitted successfully. An admin will verify your TikTok payment setup and complete your onboarding.
            </p>
            <p className={`text-xs mt-2 font-sequel ${
              isDark ? 'text-yellow-300/60' : 'text-yellow-700/80'
            }`}>
              You'll be notified once your onboarding is complete. You can close this window and continue using the platform.
            </p>
          </div>
        </div>
      </div>
