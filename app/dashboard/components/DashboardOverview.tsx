    ...
    <>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className={`rounded-2xl p-6 border ${
          isDark
            ? 'bg-gradient-to-br from-tiktok-primary to-tiktok-primary/80 border-white/20'
            : 'bg-gradient-to-br from-tiktok-primary to-tiktok-primary/80 border-gray-200'
        }`}>
          <div className="flex items-center justify-between mb-4">
            ...
            <Wallet size={28} weight="regular" className="text-white/80" />
          </div>
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2.5 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 text-sm ${
                balance === 0
                  ...
                  : 'bg-white text-tiktok-primary hover:bg-white/90'
              }`}
            >
            ...
            {onboardingStatus === 'completed' && creditStatus !== 'pending' && (
              <button
                onClick={onNewCredit}
                className="flex-1 py-2.5 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 bg-white/10 text-white hover:bg-white/20 border border-white/20 text-sm"
              >
          ...
          {balance > 0 && onTransferToWallet && (
            <button
              ...
              className="mt-2 w-full py-2 rounded-xl font-semibold transition-all flex items-center justify-center space-x-2 bg-white/10 text-white hover:bg-white/20 border border-white/20 text-xs font-sequel"
            >
        ...
        <div className={`mt-4 p-4 rounded-xl border ${
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 bg-tiktok-primary text-white rounded-lg font-semibold hover:bg-tiktok-primary/90 transition-all text-sm font-sequel flex items-center space-x-2 w-full md:w-auto"
            >
            ...
            {(activities && activities.length > 0 ? activities : transactions).slice(0, 3).map((item) => {
              ...
              const getActivityIcon = () => {
                if (type === 'credit' || type === 'credit_request' || type === 'deposit') {
                  ...
                  return <ArrowDownRight size={16} weight="regular" className="text-tiktok-primary" />
                } else {
